...
const tracks = [
  {
    ...
    videos: [
      { id: 'v1', name: 'Bass Cam', file: '/videos/happy_bass1.mp4' },
      { id: 'v2', name: 'Drum Cam', file: '/videos/happy_drum1.mp4' },
      { id: 'v3', name: 'Clarinet Cam', file: '/videos/happy_clarinet1.mp4' },
    ],
    subTracks: [
      { id: '1-1', name: 'Drums', file: '/audio/happy_drum1.wav' },
      { id: '1-2', name: 'Bass', file: '/audio/happy_bass1.wav' },
      { id: '1-3', name: 'Clarinet', file: '/audio/happy_clarinet1.wav' },
